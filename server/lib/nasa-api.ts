...
export async function fetchNASAMissions(): Promise<NASAMissionData[]> {
  ...
  },
  {
    ...
    datasetUrl: "https://nssdc.gsfc.nasa.gov/planetary/venera.html",
    color: "#fca5a5",
    icon: "🌋"
  },
  {
    ...
    datasetUrl: "https://nssdc.gsfc.nasa.gov/nmc/spacecraft/display.action?id=1984-125A",
    color: "#fca5a5",
    icon: "🎈"
  },
  {
    ...
    datasetUrl: "https://nssdc.gsfc.nasa.gov/planetary/galileo.html",
    color: "#fca5a5",
    icon: "📡"
  },
  {
    ...
    datasetUrl: "https://nssdc.gsfc.nasa.gov/planetary/cassini.html",
    color: "#fca5a5",
    icon: "🛰️"
  },
  {
  ...
  },
  {
    ...
    datasetUrl: "https://nssdc.gsfc.nasa.gov/nmc/spacecraft/display.action?id=1962-041A",
    color: "#fca5a5",
    icon: "🛰️"
  },
  {
    ...
    datasetUrl: "https://nssdc.gsfc.nasa.gov/nmc/spacecraft/display.action?id=1967-060A",
    color: "#fca5a5",
    icon: "📡"
  },
  {
  ...
  },
  {
    ...
    status: "Completed",
    planet: "Venus",
    launchDate: "June 8 & 14, 1975",
    description:
      "First spacecraft to send images from the Venusian surface. Orbiter + lander system.",
    objectives: [
      "Surface imaging",
      "Atmospheric analysis",
      "Cloud structure study"
    ],
    datasetUrl: "https://nssdc.gsfc.nasa.gov/nmc/spacecraft/display.action?id=1975-051A",
    color: "#fca5a5",
    icon: "📸"
  },
    { id: "venera7", name: "Venera 7", agency: "Soviet Union", status: "Completed", planet: "Venus", launchDate: "August 17, 1970", completionDate: "December 15, 1970", description: "First spacecraft to soft-land on Venus and transmit data from surface. Operated for 23 minutes despite extreme conditions of 465°C.", objectives: ["Land on Venus surface", "Transmit surface data", "Measure temperature and pressure", "Test landing systems"], datasetUrl: "https://en.wikipedia.org/wiki/Venera_7", color: "#f59e0b", icon: "🏠" },
